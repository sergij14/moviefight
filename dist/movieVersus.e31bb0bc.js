...
},{"../es":"node_modules/core-js/es/index.js","../web":"node_modules/core-js/web/index.js","../internals/path":"node_modules/core-js/internals/path.js"}],"utils.js":[function(require,module,exports) {
"use strict";
...
var utilities = _interopRequireWildcard(require("./utils.js"));
...
var autocomplete = _interopRequireWildcard(require("./autocomplete.js"));
...
var autocompleteConfig = {
  renderOption: function renderOption(movie) {
    ...
    return "\n    <img src=\"".concat(imgSrc, "\" />\n\n    <span>").concat(movie.Title, " (").concat(movie.Year, ")</span>\n    ");
  },
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("https://www.omdbapi.com/?apikey=4f064761&s=".concat(searchTerm));
            ...
            case 8:
              return _context.abrupt("return", data.Search);
...
autocomplete.createAutoComplete(_objectSpread(_objectSpread({}, autocompleteConfig), {}, {
...
var onMovieSelect = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(movie, element, side) {
    var resp, data;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("https://www.omdbapi.com/?apikey=4f064761&i=".concat(movie.imdbID));
  ...
  return function onMovieSelect(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var runComparison = function runComparison() {
  var leftStats = document.querySelectorAll("#left-summary .item-info article");
  var rightStats = document.querySelectorAll("#right-summary .item-info article");
  leftStats.forEach(function (leftStat, index) {
    var rightStat = rightStats[index];
    var leftValue = leftStat.dataset.value;
    var rightValue = rightStat.dataset.value;
...
var itemMarkup = function itemMarkup(itemDetail) {
  var dollars = parseInt(itemDetail.BoxOffice.replace(/\$/g, "").replace(/,/g, ""));
  var metascore = parseInt(itemDetail.Metascore);
  var imdbRating = parseFloat(itemDetail.imdbRating);
  var imdbVotes = parseInt(itemDetail.imdbVotes.replace(/,/g, ""));
  var awards = itemDetail.Awards.split(" ").reduce(function (prev, word) {
  ...
  return "\n<article class=\"item\">\n<figure class=\"item-left\">\n<img src=\"".concat(itemDetail.Poster, "\" />\n</figure>\n<figure class=\"item-right\">\n<h1>").concat(itemDetail.Title, "</h1>\n<h4>").concat(itemDetail.Genre, "</h4>\n<p>").concat(itemDetail.Plot, "</p>\n</figure>\n</article>\n<div class=\"item-info mar-t\">\n<article data-value=\"").concat(awards, "\">\n<p class=\"title\">").concat(itemDetail.Awards, "</p>\n<p class=\"subtitle\">Awards</p>\n</article>\n<article data-value=\"").concat(dollars, "\">\n<p class=\"title\">").concat(itemDetail.BoxOffice, "</p>\n<p class=\"subtitle\">Box Office</p>\n</article>\n<article data-value=\"").concat(metascore, "\">\n<p class=\"title\">").concat(itemDetail.Metascore, "</p>\n<p class=\"subtitle\">Meta Score</p>\n</article>\n<article  data-value=\"").concat(imdbRating, "\">\n<p class=\"title\">").concat(itemDetail.imdbRating, "</p>\n<p class=\"subtitle\">IMDB Rating</p>\n</article>\n<article data-value=\"").concat(imdbVotes, "\">\n<p class=\"title\">").concat(itemDetail.imdbVotes, "</p>\n<p class=\"subtitle\">IMDB Votes</p>\n</article>\n</div>\n");
};
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/stable":"node_modules/core-js/stable/index.js","./autocomplete.js":"autocomplete.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/movieVersus.e31bb0bc.js.map